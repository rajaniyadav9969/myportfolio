            ...
            <div className="grid grid-cols-1 sm:grid-cols-12">
                ...
                >
                    ...
                    <p className='text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl'>
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Magnam, sapiente eius et non ipsum explicabo reprehenderit, totam libero molestiae nemo possimus.
                    </p>
                    <div>
